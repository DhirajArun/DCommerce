...
const { resetPassword } = require("../functions/auth");
...
router.post("/passwordReset", async (req, res) => {
  ...
  const result = await resetPassword(id, token, req.body.password);
  if (result) return res.send("password resetted successfully");
});
